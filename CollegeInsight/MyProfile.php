					...
					<div class="card-body">
						<div class="tab-content">
								...
								<form class="" action="MyProfile.php" method="post" id="" enctype="multipart/form-data">
									<div class="row">
										<div class="form-group col-md-6">
											<input class="form-control" type="text" name="firstname" id="firstname" placeholder="Firstname" value="<?php echo $ExistingFirstName;?>">
										</div>
										<div class="form-group col-md-6">
											<input class="form-control" type="text" name="lastname" id="lastname" placeholder="Lastname" value="<?php echo $ExistingLastName;?>">
										</div>
									</div>
							...
							<div class=" tab-pane" id="changePassword">
								<form class="" action="changeStudentPassword.php" method="post"  enctype="multipart/form-data">
							...
							<div class=" tab-pane" id="deleteAccount">
								<form class="" action="DeleteStudentAccount.php" method="post" enctype="multipart/form-data">
									<input type="text" name="userid"  value="<?php echo $StudentId;?>" hidden>
									<div class="form-group">
